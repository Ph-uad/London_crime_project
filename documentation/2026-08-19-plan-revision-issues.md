...
> This copy is retained unaltered as the record of what was originally specified.
>
> **Three things the merge changed**, recorded here so the difference is traceable:
>
...
>    *Delivered as* note.
>
> Full rationale: [`2026-08-19-pipeline-rebuild-record.md`](2026-08-19-pipeline-rebuild-record.md).
